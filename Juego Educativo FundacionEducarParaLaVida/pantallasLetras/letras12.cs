...
{
    public partial class letras12 : Form
    {
        public letras12()
        {
            InitializeComponent();
        ...
        private void controlBoton11()
        {
            ...
            {
                errorProvider1.SetError(textBox11, "Sílaba equivocada");
                textBox11.Focus();
            }
