...
{
    public partial class oracion7 : Form
    {
        public oracion7()
        {
            InitializeComponent();
        ...
        {
            if (textBox2.Text == "energia" || textBox2.Text == "energía")
            {
        ...
        private void oracion7_Load(object sender, EventArgs e)
        {
