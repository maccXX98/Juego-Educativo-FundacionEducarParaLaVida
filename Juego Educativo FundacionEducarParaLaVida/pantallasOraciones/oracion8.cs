...
{
    public partial class oracion8 : Form
    {
        public oracion8()
        {
            InitializeComponent();
        ...
        private void oracion8_Load(object sender, EventArgs e)
        {
