...
{
    public partial class sopa9 : Form
    {
        public sopa9()
        {
            InitializeComponent();
        ...
        private void sopa1_Load(object sender, EventArgs e)
        {
        ...
        private void button23_Click(object sender, EventArgs e)
        {
            ...
            button23.FlatAppearance.BorderColor = Color.Green;
        }
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            button27.FlatAppearance.BorderColor = Color.Green;
        }

        private void button26_Click(object sender, EventArgs e)
        {
            button26.FlatAppearance.BorderSize = 3;
            button26.FlatAppearance.BorderColor = Color.Green;
        }
        ...
        {
            button31.FlatAppearance.BorderSize = 3;
            button31.FlatAppearance.BorderColor = Color.Green;
        }

        private void button33_Click(object sender, EventArgs e)
        {
            button33.FlatAppearance.BorderSize = 3;
            button33.FlatAppearance.BorderColor = Color.Green;
        }

        private void button34_Click(object sender, EventArgs e)
        {
            button34.FlatAppearance.BorderSize = 3;
            button34.FlatAppearance.BorderColor = Color.Green;
        }

        private void button32_Click(object sender, EventArgs e)
        {
            button32.FlatAppearance.BorderSize = 3;
            button32.FlatAppearance.BorderColor = Color.Green;
        }
    }
}